...
public class FileWrapper {
    ...
    public static class Builder {
        ...
        public FileWrapper build() {
            if (this.file != null) {
                if (this.filename == null) this.filename = file.getName();
            } else if (this.content != null) {
                if (this.filename == null) throw new HttpClientException("Filename may not be null");
            } else {
                throw new HttpClientException("The content is null.");
            }
            if (this.mediaType == null) this.mediaType = Utils.guessMediaType(this.filename);
