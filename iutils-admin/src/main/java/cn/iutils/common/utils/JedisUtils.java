...
public class JedisUtils {
    ...
    public static void init() {
        try {
            ...
            if (properties != null) {
                ...
                if (org.apache.commons.lang3.StringUtils.isBlank(port) || !org.apache.commons.lang3.StringUtils.isNumeric(port)) {
                    port = "6379";
                }
                int portIn = Integer.parseInt(port);
                jedisPool = new JedisPool(config, jedis_ip, portIn, 5000);
            } else {
                logger.warn("加载redis.properties失败!");
            }
        } catch (IOException e) {
            logger.error("加载redis.properties出现异常", e);
        }
    }
    ...
    public static Jedis getResource() throws JedisException {
        ...
        try {
            ...
            jedis.auth(properties.getProperty("redis.auth"));
            return jedis;
    ...
    public static byte[] getBytesKey(Object key) {
        if (key instanceof String) {
            return StringUtils.getBytes((String) key);
        } else {
     ...
     * @return
     */
    public static Object toObject(byte[] key) {
        return ObjectUtils.unserialize(key);
    }
