...
import cn.iutils.common.utils.excel.exceptions.TimeMatchFormatException;
...
public class DateUtils {
    ...
    static public final String DATE_FORMAT_DAY_3 = "yyyy/M/d";
     ...
     * 匹配yyyy/M/d
     */
    private static final String DATE_REG_3 = "^[1-9]\\d{3}/([1-9])/([1-9])$";
    /**
     * 匹配HH:mm:ss
     */
    ...
    public static Date str2Date(String strDate) throws TimeMatchFormatException,
        ...
        if (RegularUtils.isMatched(strDate, DATE_REG_3)) {
            sdf = new SimpleDateFormat(DATE_FORMAT_DAY_3);
        }
