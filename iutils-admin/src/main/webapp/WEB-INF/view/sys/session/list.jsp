                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            <div class="am-u-sm-12 am-u-md-3 am-u-lg-3" style="display:none;">
                            ...
                            <div class="am-u-sm-12 am-u-md-9 am-u-lg-9" style="display: none;">
                                ...
                                <table id="contentTable"
                                    ...
                                    <c:forEach items="${page.list}" var="session" varStatus="status">
                                        <tr>
                                            ...
                                            <td><fmt:formatDate value="${session.startTimestamp}"
                                            ...
                                            <shiro:hasPermission name="sys:session:forceLogout">
                                                <td>
                                                    <c:if test="${not fnc:isForceLogout(session)}">
                                                        <a href="${ctx}/sys/session/${session.id}/forceLogout?pageNo=${page.pageNo}&pageSize=${page.pageSize}"
