                                ...
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button type="button" class="am-btn am-btn-default am-btn-success"
                                                onclick="openModel(false,'${ctx}/mt/project/create')"><span class="am-icon-plus"></span> 新增
                                        </button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table id="contentTable" class="am-table am-table-compact am-table-striped tpl-table-black">
                                    ...
                                    <c:forEach items="${page.list}" var="project" varStatus="status">
                                        <tr>
                                                ...
                                                <td>${project.updateBy}</td>
                                                <td>${project.updateDate}</td>
                                                <td>${project.remarks}</td>
                                                <td>${project.status}</td>
                                            <td>
                                                <a href="javascript:;" onclick="openModel('修改军训项目表','${ctx}/mt/project/update?id=${project.id}')" title="编辑"><span class="am-icon-pencil"></span></a>
                                                <a href="${ctx}/mt/project/${project.id}/delete?pageNo=${page.pageNo}&pageSize=${page.pageSize}" onclick="return confirm('确认要删除该条数据吗？', this.href)" title="删除"><span class="am-text-danger am-icon-trash-o"></span></a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
