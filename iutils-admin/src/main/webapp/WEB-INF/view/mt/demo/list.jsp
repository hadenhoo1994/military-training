                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">demo表</div>
                        </div>
                        <div class="widget-body am-fr">
                                ...
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button type="button" class="am-btn am-btn-default am-btn-success"
                                                onclick="openModel(false,'${ctx}/mt/demo/create')"><span class="am-icon-plus"></span> 新增
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="am-u-sm-12 am-u-md-9 am-u-lg-9">
                                <form id="searchForm" action="${ctx}/mt/demo" method="post">
                                ...
                                <table id="contentTable" class="am-table am-table-compact am-table-striped tpl-table-black">
                                    ...
                                    <c:forEach items="${page.list}" var="demo" varStatus="status">
                                        <tr>
                                                ...
                                                <td>${demo.status}</td>
                                            <td>
                                                <a href="javascript:;" onclick="openModel('修改demo表','${ctx}/mt/demo/update?id=${demo.id}')" title="编辑"><span class="am-icon-pencil"></span></a>
                                                <a href="${ctx}/mt/demo/${demo.id}/delete?pageNo=${page.pageNo}&pageSize=${page.pageSize}" onclick="return confirm('确认要删除该条数据吗？', this.href)" title="删除"><span class="am-text-danger am-icon-trash-o"></span></a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
