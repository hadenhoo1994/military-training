                                ...
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button type="button" class="am-btn am-btn-default am-btn-success"
                                                onclick="openModel(false,'${ctx}/mt/grade/create')"><span
                                ...
                                <table id="contentTable"
                                    ...
                                    <c:forEach items="${page.list}" var="grade" varStatus="status">
                                        <tr>
                                            ...
                                            <td>${grade.name}</td>
                                            <td><fmt:formatDate value="${grade.createDate}"
                                                                pattern="yyyy-MM-dd hh:mm:ss"></fmt:formatDate></td>
                                            <td><fmt:formatDate value="${grade.updateDate}"
                                                                pattern="yyyy-MM-dd hh:mm:ss"></fmt:formatDate></td>
                                            <td>${grade.remarks}</td>
                                            <td>
                                                <a href="javascript:;"
                                                   onclick="openModel('修改届表','${ctx}/mt/grade/update?id=${grade.id}')"
                                                   title="编辑"><span class="am-icon-pencil"></span></a>
                                                <a href="${ctx}/mt/grade/${grade.id}/delete?pageNo=${page.pageNo}&pageSize=${page.pageSize}"
