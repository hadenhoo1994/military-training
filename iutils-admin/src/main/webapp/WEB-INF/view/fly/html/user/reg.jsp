          ...
          <div class="layui-form layui-form-pane">
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" id="L_email" name="email" required lay-verify="required|phone" autocomplete="off" class="layui-input">
                </div>
              ...
              <div class="layui-form-item">
                <button class="layui-btn" lay-filter="*"  onclick="reg()">立即注册</button>
              </div>
...
<script>
    function reg(){
        ...
        $.ajax({
            type: "POST",
            url: "/fly/users/reg",
            data: {mobileNumber: account, password:password,repsw:repass,name:name},
            dataType: "json",
            cache: false,
            async: false,
