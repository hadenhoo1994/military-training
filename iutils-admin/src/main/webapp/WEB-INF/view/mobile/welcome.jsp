                ...
                <div class="widget am-cf">
                    ...
                    <div class="widget-body widget-body-md am-fr">
                        ...
                        <div class="am-progress-title">CPU Load <span
                                class="am-fr am-progress-title-more">28% / 100%</span></div>
        ...
        <div class="row am-cf">
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-4 widget-margin-bottom-lg ">
                <div class="tpl-user-card am-text-center widget-body-lg">
                    ...
                    <img class="achievement-image" src="${ctxStatic}/assets/img/user07.png" alt="">
...
<script src="${ctxStatic}/3rd-lib/amazeui/js/amazeui.datatables.min.js"></script>
<script src="${ctxStatic}/assets/js/dataTables.responsive.min.js"></script>
</body>
</html>