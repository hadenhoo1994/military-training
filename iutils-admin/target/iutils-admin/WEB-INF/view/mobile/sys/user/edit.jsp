                        ...
                        <div class="widget-body am-fr">
                            <form class="am-form tpl-form-border-form" data-am-validator modelAttribute="user"
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left"><span class="error">*</span>账号：</label>
                                ...
                                <c:if test="${empty user.id}">
                                    <div class="am-form-group">
                                        <label class="am-u-sm-12 am-form-label am-text-left"><span
                                                class="error">*</span>密码：</label>
                                        <div class="am-u-sm-12">
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left"><span class="error">*</span>是否部门管理员：</label>
                                    <div class="am-u-sm-12">
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left"><span class="error">*</span>所属机构：</label>
                                    <div class="am-u-sm-12">
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left">角色列表：</label>
                                    <div class="am-u-sm-12">
                                        <select name="roleIds"
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left">姓名：</label>
                                    <div class="am-u-sm-12">
                                        <input type="text" name="name" placeholder="姓名" value="${user.name}"/>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left">邮箱：</label>
                                    <div class="am-u-sm-12">
                                        <input type="text" name="email" placeholder="邮箱" value="${user.email}"/>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left">手机：</label>
                                    <div class="am-u-sm-12">
                                        <input type="text" name="mobile" placeholder="手机" value="${user.mobile}"/>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left">电话：</label>
                                    <div class="am-u-sm-12">
                                        <input type="text" name="phone" placeholder="电话" value="${user.phone}"/>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left">是否锁定：</label>
                                    <div class="am-u-sm-12">
