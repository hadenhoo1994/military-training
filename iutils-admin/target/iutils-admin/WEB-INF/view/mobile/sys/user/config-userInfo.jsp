                        ...
                        <div class="widget-body am-fr">
                            <form class="am-form tpl-form-border-form" modelAttribute="user"
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left">用户头像：</label>
                                    <div class="am-u-sm-12 am-margin-top-xs">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img tpl-user-panel-profile-picture">
                                                <img id="showPic"
                                                     src="<c:if test="${not empty user.photo}">${pageContext.request.contextPath}/${user.photo}</c:if>"
                                                     alt="">
                                            </div>
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left">个人简介：</label>
                                    <div class="am-u-sm-12 am-margin-top-xs">
