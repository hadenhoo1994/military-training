                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">资源新增</div>
                        </div>
                        <div class="widget-body am-fr">
                            <form class="am-form tpl-form-border-form" data-am-validator modelAttribute="resource"
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left">上级资源：</label>
                                    <div class="am-u-sm-12">
                                        <input type="text" id="parentName" minlength="1" value="${resource.name}"
                                               readonly/>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-12">
                                        <input type="number" name="sort" minlength="1" value="0" placeholder="排序（必填）"
                                               required/>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left">类型：</label>
                                    <div class="am-u-sm-12">
